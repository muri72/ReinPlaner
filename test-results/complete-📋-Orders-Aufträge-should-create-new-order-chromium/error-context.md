...
- Name: complete.spec.ts >> 📋 Orders (Aufträge) >> should create new order
- Location: e2e/complete.spec.ts:317:7
...
Locator: getByLabel(/titel|name|bezeichnung/i).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel(/titel|name|bezeichnung/i).first()
