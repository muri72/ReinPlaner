...
- Name: complete.spec.ts >> 📅 Planning (Dienstplanung) >> should display calendar view
- Location: e2e/complete.spec.ts:452:7
...
Locator: locator('[class*="calendar"], [class*="plan"], table').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="calendar"], [class*="plan"], table').first()
