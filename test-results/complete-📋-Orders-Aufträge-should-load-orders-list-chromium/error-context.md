...
- Name: complete.spec.ts >> 📋 Orders (Aufträge) >> should load orders list
- Location: e2e/complete.spec.ts:275:7
...
Locator: getByRole('heading', { name: /aufträge|orders/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /aufträge|orders/i }).first()
