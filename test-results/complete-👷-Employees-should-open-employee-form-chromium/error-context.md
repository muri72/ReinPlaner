...
- Name: complete.spec.ts >> 👷 Employees >> should open employee form
- Location: e2e/complete.spec.ts:255:7
...
Locator: getByLabel(/name|vorname|nachname/i).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel(/name|vorname|nachname/i).first()
