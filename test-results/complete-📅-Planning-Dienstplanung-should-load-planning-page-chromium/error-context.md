...
- Name: complete.spec.ts >> 📅 Planning (Dienstplanung) >> should load planning page
- Location: e2e/complete.spec.ts:443:7
...
Locator: getByRole('heading', { name: /planung|planning/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /planung|planning/i }).first()
