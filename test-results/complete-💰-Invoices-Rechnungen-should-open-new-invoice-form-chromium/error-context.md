...
- Name: complete.spec.ts >> 💰 Invoices (Rechnungen) >> should open new invoice form
- Location: e2e/complete.spec.ts:407:7
...
Locator: getByLabel(/kunde|customer|debitor/i).first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel(/kunde|customer|debitor/i).first()
