...
export default function ImpressumPage() {
  return (
    <MarketingPage maxWidth="lg">
      <h1 className="text-3xl font-bold dark:text-white mb-8">Impressum</h1>

      <div className="glass-card p-8 space-y-8">
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Angaben gemäß § 5 TMG</h2>
          
          <p className="text-slate-300 mb-4">
            <strong className="dark:text-white">ReinPlaner</strong><br />
            Musterstraße 123<br />
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
          <p className="text-slate-300 mb-4">
            Max Mustermann<br />
            Musterstraße 123<br />
            12345 Musterstadt
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Haftung für Inhalte</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Haftung für Links</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Umsatzsteuer-ID</h2>
          <p className="text-slate-300 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">Streitschlichtung</h2>
          <p className="text-slate-400 mb-4">
