...
export default function DatenschutzPage() {
  return (
    <MarketingPage maxWidth="lg">
      <h1 className="text-3xl font-bold dark:text-white mb-8">Datenschutzerklärung</h1>
      ...
      <div className="glass-card p-8 space-y-8">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">1. Datenschutz auf einen Blick</h2>
          
          <h3 className="text-lg font-semibold dark:text-white mt-4 mb-2">Allgemeine Hinweise</h3>
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">2. Datenerfassung auf unserer Website und in unserer Software</h2>
          
          <h3 className="text-lg font-semibold dark:text-white mt-4 mb-2">Wer ist verantwortlich für die Datenerfassung?</h3>
          <p className="text-slate-400 mb-4">
          ...
          <h3 className="text-lg font-semibold dark:text-white mt-4 mb-2">Welche Daten erfassen wir?</h3>
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">3. Hosting</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">4. Kontaktformular und Registrierung</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">5. Ihre Rechte</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">6. SSL-Verschlüsselung</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">7. Cookies</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">8. Google Fonts</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">9. Änderungen dieser Datenschutzerklärung</h2>
          <p className="text-slate-400 mb-4">
        ...
        <section>
          <h2 className="text-xl font-semibold dark:text-white mt-6 mb-4">10. Kontakt</h2>
          <p className="text-slate-400 mb-4">
