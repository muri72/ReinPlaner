  ...
  return (
    <>
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-5xl max-w-[calc(100vw-2rem)] max-h-[90vh] flex flex-col p-0 border bg-background shadow-xl" onOpenAutoFocus={(e) => e.preventDefault()}>
