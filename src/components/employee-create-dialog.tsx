...
export function EmployeeCreateDialog({ onEmployeeCreated }: EmployeeCreateDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent key={open ? "employee-create-open" : "employee-create-closed"} className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto" aria-labelledby="employee-create-dialog-title">
        <DialogHeader>
