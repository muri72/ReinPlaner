...
export function DashboardClientLayout({ children, currentUserRole, onSignOut }: DashboardClientLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <aside
        className={cn(
          "hidden md:flex flex-col fixed top-0 left-0 h-screen bg-sidebar text-sidebar-foreground border-r border-sidebar-border p-4 transition-all duration-300 ease-in-out z-40 overflow-hidden", // Changed duration to 300ms
      ...
      <main className={cn(
        ...
        "pt-20 md:pt-8",
        "transition-all duration-300 ease-in-out", // Changed duration to 300ms
