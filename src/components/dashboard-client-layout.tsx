        ...
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
          ...
          <SheetContent
            ...
            className={cn(
              ...
              "h-full relative" // Wichtig: SheetContent muss 'relative' sein, damit 'absolute' Kinder richtig positioniert werden
            )}
          >
            <SheetHeader className="p-4 mb-6 flex items-center justify-center"> {/* Nur für den Titel, zentriert */}
            ...
            <SheetClose asChild>
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-4 h-8 w-8" // Absolute Positionierung oben rechts im SheetContent
              >
                <X className="h-5 w-5" />
