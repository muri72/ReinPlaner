...
export function AssignmentEditDialog({ orderId, children, onSuccess }: AssignmentEditDialogProps) {
  ...
  const footer = (
    <div className="flex justify-end gap-3">
      ...
      <Button type="submit" form="assignment-edit-form" disabled={form.formState.isSubmitting}>
  ...
  return (
    <RecordDialog
      ...
      title={`Einsatz bearbeiten: ${orderTitle}`}
      description="Passen Sie das zugewiesene Team und den Zeitplan für diesen Auftrag an."
    ...
    >
      ...
      {loading ? (
        ...
        <form id="assignment-edit-form" onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4">
          <div>
