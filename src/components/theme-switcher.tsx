...
export function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center h-10 w-10 text-slate-400 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors"
